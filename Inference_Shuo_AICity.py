...
import mxnet as mx
from function.inference_rcnn import inference_rcnn_AICity
...
def main():
    ...
    inference_rcnn_AICity(config, config.dataset.dataset, config.dataset.test_image_set, config.dataset.root_path, config.dataset.dataset_path,
