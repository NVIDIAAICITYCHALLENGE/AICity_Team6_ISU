...
class MutableModule_Shuo(BaseModule):
    """A mutable module is a module that supports variable input data.
    ...
    def __init__(self, symbol, data_names, label_names,
                 logger=logging, context=ctx.cpu(), work_load_list=None,
                 max_data_shapes=None, max_label_shapes=None, fixed_param_prefix=None, fixed_param_names=None):
        super(MutableModule_Shuo, self).__init__(logger=logger)
        self._symbol = symbol
        self._data_names = data_names
        self._label_names = label_names
        self._context = context
